        ...
        <div className="content">
          <div className="form-detail-product">
            ...
            <div className="productname">
              ...
              <input type="text" id="nameProduct" className="form-control" maxLength="25"
                placeholder="Input your product name" value={productName} onChange={handleProductNameChange} />

              <div className="alert alert-warning mt-2" id="nameLengthAlert"
                style={{ display: alertMessage ? "block" : "none" }} role="alert">
                {alertMessage}
              </div>
              <div className="alert alert-danger alert-dismissible fade show mt-2" id="alertPrice"
                style={{ display: alertProductEmpty ? "block" : "none" }} role="alert">
                {alertProductEmpty}
            ...
            <div className="select-category">
              ...
              <select className="form-select" id="selectCategory" aria-label="Default select example"
            ...
            <div className="img">
              ...
              <div className="input-group">
                <input type="file" className="form-control image" id="inputImg" aria-describedby="inputGroupFileAddon04"
                  aria-label="Upload" />
              </div>
            </div>
            ...
            <div className="product-freshness">
              ...
              <div className="form-check">
                <input className="form-check-input" type="radio" name="flexRadioDefault" value="Brand New"
                  id="RadioDefault1" checked={productFreshness==="Brand New" } onChange={()=> setProductFreshness("Brand New")}
                />
              ...
              <div className="form-check">
                <input className="form-check-input" type="radio" name="flexRadioDefault" value="Second Hand"
                  id="RadioDefault1" checked={productFreshness==="Second Hand" } onChange={()=> setProductFreshness("Second Hand")}
                />
              ...
              <div className="form-check">
                <input className="form-check-input" type="radio" name="flexRadioDefault" value="Refufbished"
                  id="RadioDefault1" checked={productFreshness==="Refufbished" } onChange={()=>
                setProductFreshness("Refufbished")}
                />
                <label className="form-check-label" htmlFor="flexRadioDefault1">
                  Refufbished
                </label>
            ...
            <div className="price">
              ...
              <div className="input-group mb-3">
                ...
                value={priceProduct} onChange={(event)=> setPriceProduct(event.target.value)}
                placeholder="1"
                />
              </div>
              <div className="alert alert-danger alert-dismissible fade show mt-2" id="alertPrice"
                style={{ display: alertPriceEmpty ? "block" : "none" }} role="alert">
                {alertPriceEmpty}
                <button type="button" className="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
              </div>
            </div>
