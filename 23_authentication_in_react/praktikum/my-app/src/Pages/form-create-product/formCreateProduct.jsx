...
export default function FormProduct() {
  ...
  const { addProductResult } = useSelector((state) => state.Products);
  ...
  useEffect(() => {
    if (addProductResult) alert("Data berhasil disimpan");
  ...
  return (
    <main>
      <form onSubmit={(event) => eventHandlerSubmit(event)}>
